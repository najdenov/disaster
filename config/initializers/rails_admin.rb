...
RailsAdmin.config do |config|
  ...
  config.included_models = ['Article','Article::Translation', 'User', 'User::Translation', 'SliderItem', 'SliderItem::Translation', 'Member', 'Member::Translation', 'Event', 'Event::Translation', 'Album', 'Photo', 'Album::Translation', 'Page', 'Page::Translation', 'Photo::Translation', 'Video', 'Video::Translation', 'PicOfTheWeek', 'PicOfTheWeek::Translation']
  ...
  config.model 'PicOfTheWeek::Translation' do
    visible false
    configure :locale, :hidden
    include_fields :locale, :rider, :location, :photographer
  end
  ...
  config.model 'Album::Translation' do
    visible false
    configure :locale, :hidden
    include_fields :locale, :title, :summary, :photographer, :location
  end
  ...
  config.model 'Photo::Translation' do
    visible false
    configure :locale, :hidden
    include_fields :locale, :caption
  end
